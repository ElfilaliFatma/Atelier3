...
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <div class="mb-4">
        ...
        <input id="name" type="text" name="name" class="shadow border rounded w-full p-2" value="{{ old('name') }}" placeholder="Nom d'utilisateur" autofocus>
        @error('name')
    ...
    <div class="mb-4">
        ...
        <input id="email" type="email" name="email" class="shadow border rounded w-full p-2" value="{{ old('email') }}" placeholder="Votre email" autofocus>
        @error('email')
            <span class="text-red-400 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="mb-4">
        ...
        <input id="password" type="password" name="password" class="shadow border rounded w-full p-2" placeholder="Votre mot de passe">
        @error('password')
            <span class="text-red-400 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="mb-4">
        ...
        <input id="password_confirmation" type="password" name="password_confirmation" class="shadow border rounded w-full p-2" placeholder="Retapez votre mot de passe">
    </div>
